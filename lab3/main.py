...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', type=str,
                        help='Путь к выходному файлу (опционально)', default=None)
    ...
    fig, axes = create_comparison_charts(
        original_count, reduced_count, factor, samplerate)

    plt.savefig(args.output+"\\audio_comparison_charts.png", dpi=150, bbox_inches='tight')
    print("График сохранен как 'audio_comparison_charts.png'")

    sf.write(args.output+"\\new_file.mp3", data_reduced, samplerate)
    plt.show()
